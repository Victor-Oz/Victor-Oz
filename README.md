...
- 🌱 I’m currently Working with JavaScript, Reactjs , Context API, Sass, CSS, HTML , Material UI, Bootstrap, Styled Components, JQuery, React Testing Library, Netlify, Figma ,Git ,Github, Responsive Web Design, CSS Animations, Framer Motion , web Accesibility ,Jsx ,parcel , vite , Tecnical Writing.
